...
// 		$db->beginTransaction();//ទប់ស្កាត់មើលការErrore , មានErrore វាមិនអោយចូល
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$invoice_no=$register->getInvoiceNo(3,0);
	...
	function updateInvoiceTransport($data,$id){
		//$db = $this->getAdapter();//ស្ពានភ្ជាប់ទៅកាន់Data Base
		//$db->beginTransaction();//ទប់ស្កាត់មើលការErrore , មានErrore វាមិនអោយចូល
    ...
    function getAllNewStudentName(){
    	...
    	$sql="SELECT s.stu_id , CONCAT(s.stu_khname,'-',s.stu_enname) as stu_name from rms_student as s  where s.status=1 and s.is_subspend=0 
    ...
    function getAllOldStudentName(){
    	...
    	$sql="SELECT s.stu_id , CONCAT(s.stu_khname,'-',s.stu_enname) as stu_name from rms_student as s,rms_service as sv  
    		  where sv.stu_id = s.stu_id and sv.type=4 and sv.status=1 $is_suspend $branch_id ";
    	return $db->fetchAll($sql);
    }
