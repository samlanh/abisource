<?php 
Class Registrar_Form_FrmInvoiceParttime extends Zend_Dojo_Form {
	protected $tr=null;
...
// 				4=>$this->tr->translate('DOCTORATE'));
	...
	public function FrmRegistarWU($data=null){
		...
		$invoice=new Registrar_Model_DbTable_DbRegister();
		$opt=$invoice->getInvoiceNo(2,0);
		...
		$opt_gep=$invoice->getAllGepOldStudent();
		...
		$opt_gep_name=$invoice->getAllGepOldStudentName();
...
// 				'required'=>'true',
		...
		$opt_ger=$invoice->getAllDropStudentID(2);
...
// 				'required'=>'true',
		...
		$opt_ger_name=$invoice->getAllDropStudentName(2);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$books = new Zend_Form_Element_Hidden('books');
		$books->setValue(0);
